...
const MINIMUM_DURATION_MS = 10 * 60 * 1000; // 5 minutes minimum
const RANDOM_ADDITIONAL_SPAN_MS = 30 * 60 * 1000; // The random part spans 30 minutes
export const BATTLE_ROYALE_DURATION = MINIMUM_DURATION_MS + Math.floor(Math.random() * RANDOM_ADDITIONAL_SPAN_MS);
